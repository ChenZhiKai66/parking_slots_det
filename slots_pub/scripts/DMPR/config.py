...
# VSLOT_MIN_DIST = 0.044771278151623496  # 停车位大小阈值(原有的） *5/6
# VSLOT_MAX_DIST = 0.1099427457599304  # 这个尺寸*图片分辨率
# HSLOT_MIN_DIST = 0.15057789144568634
# HSLOT_MAX_DIST = 0.44449496544202816
VSLOT_MIN_DIST = 0.018811461  # 停车位大小阈值 垂直
VSLOT_MAX_DIST = 0.06
HSLOT_MIN_DIST = 0.28  # 水平的
HSLOT_MAX_DIST = 0.3
# VSLOT_MIN_DIST = 0.0373
# VSLOT_MAX_DIST = 0.091618955
# HSLOT_MIN_DIST = 0.125481576
# HSLOT_MAX_DIST = 0.370412471

# SHORT_SEPARATOR_LENGTH = 0.199519231  # 车位深度
# LONG_SEPARATOR_LENGTH = 0.46875
SHORT_SEPARATOR_LENGTH = 0.166266026  # 车位深度
LONG_SEPARATOR_LENGTH = 0.390625
...
def add_common_arguments(parser):
    ...
    parser.add_argument('--detector_weights', default='dmpr_pretrained_weights.pth',
...
def get_parser_for_training():
    ...
    parser.add_argument('--dataset_directory', required=False, default='/home/czk/0NewDisk/MyCode/PSD/DMPR-PS-master/dataset/test/',
